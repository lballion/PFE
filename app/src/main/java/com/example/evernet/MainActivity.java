    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            Uri selectedImage = data.getData();
               ...
               fileManager =new FileManager(imageView);
            ...
            fileManager.getImg().setImageBitmap(finalBitmap);
           // String savedImageURL = MediaStore.Images.Media.insertImage(getContentResolver(), finalBitmap, "Bird", "Image of bird");
                Toast.makeText(getBaseContext(), "height before =" +fileManager.getHeight() +" heightAfter="+fileManager.newHeight+" widBefo = "+fileManager.getWidth()+" widAft = " +fileManager.newWidth
                        +" sizeAr= "+fileManager.getSizeOfBytesArray()+" StrinA= "+fileManager.getSizeOfImageString()
